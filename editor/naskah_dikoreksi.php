                    ...
                    <?php foreach($revisi as $rev) {
                      ...
                      if ($dta) {
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="#" class="btn btn-icon icon-left btn-primary btn-sm" data-toggle="modal" data-target="#modal-berita<?= $dta['id'] ?>" data-toggle1="tooltip" title="" data-original-title="Lihat Isi Berita Koreksi/Revisi"><i class="far fa-eye"></i></a>
                          </td>
                          <td>
                            <div class="badge <?= $color ?> col-12"><?= $caption ?></div>
                          </td>
                          <td style="min-width: 140px; max-width: 140px;" class="text-center">
                            <a href="koreksi_berita_revisi.php?berita_id=<?= $dta['id'] ?>" class="btn btn-icon btn-sm btn-warning"><i class="fas fa-keyboard"></i> Koreksi</a>
                            <a href="controller.php?accept=true&from=naskah_dikoreksi&berita_id=<?= $dta['id'] ?>" class="btn btn-icon btn-sm btn-success"><i class="fas fa-check"></i> Accept</a>
                          </td>
                        </tr>
                      <?php }
                    } ?>
