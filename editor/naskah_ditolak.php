                      ...
                      if ($dta) {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="controller.php?arsip=true&from=naskah_ditolak&berita_id=<?= $dta['id'] ?>" class="btn btn-icon icon-left btn-warning btn-sm" data-toggle1="tooltip" title="" data-original-title="Arsip Naskah"><i class="fa fa-archive"></i> Arsip</a>
                          </td>
                        </tr>
                      <?php }
                    } ?>
