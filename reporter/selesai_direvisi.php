...
$berita = mysqli_query($conn, "SELECT * FROM tb_berita WHERE user_id = '$id' AND status = 'done'");
?>
<!-- Main Content -->
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Naskah Selesai Direvisi</h1>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Data Naskah Yang Selesai Direvisi (Menunggu Persetujuan)</h4>
            </div>
            <div class="card-body">
...
<script>
  $(document).ready(function() {
    ...
    $('#selesai_direvisi').addClass('active');
