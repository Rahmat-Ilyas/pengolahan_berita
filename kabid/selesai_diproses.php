...
$berita = mysqli_query($conn, "SELECT * FROM tb_berita WHERE status = 'verify' OR status = 'verify_' OR status = 'refuse' OR status = 'refuse_'");
?>
<!-- Main Content -->
                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <?php foreach($berita as $dta) {
                      ...
                      if ($dta['status'] == 'verify_' || $dta['status'] == 'verify') {
                        $caption = 'Disetujui';
                        $color = 'badge-success';
                      } else if ($dta['status'] == 'refuse_' || $dta['status'] == 'refuse') {
                        $caption = 'Ditolak';
                        $color = 'badge-danger';
                      } ?>                                 
                      <tr>
...
<script>
  $(document).ready(function() {
    ...
    $('#selesai_diproses').addClass('active');
  });
</script>
<?php 
