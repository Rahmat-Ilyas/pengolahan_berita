                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($dta['konten'] != null) { ?>
                            <a href="#" class="btn btn-icon icon-left btn-light btn-sm" data-toggle="modal" data-target="#modal-konten<?= $dta['id'] ?>"><i class="far fa-file"></i> Konten</a>
                          <?php } else { ?>
                            <a href="#" class="btn btn-icon icon-left btn-light btn-sm disabled"><i class="far fa-file"></i> Konten</a>
                          <?php } ?>
                        </td>
                        <td>
                          <a href="#" class="btn btn-icon icon-left btn-primary btn-sm" data-toggle="modal" data-target="#modal-berita<?= $dta['id'] ?>"><i class="far fa-eye"></i> Naskah</a>
                        </td>
                        <td style="min-width: 140px; max-width: 140px;" class="text-center">
                          <a href="#" class="btn btn-icon btn-sm btn-warning"><i class="fas fa-keyboard"></i> Koreksi</a>
                          <a href="#" class="btn btn-icon btn-sm btn-success"><i class="fas fa-check"></i> Accept</a>
                        </td>
                      </tr>
                      <?php $i = $i + 1; } ?>
                    </tbody>
